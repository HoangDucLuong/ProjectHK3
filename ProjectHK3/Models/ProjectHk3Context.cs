...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MaDonHang).HasName("PK__DonDatHa__129584ADF729CF87");
        ...
        {
            entity.HasKey(e => e.MaKhachHang).HasName("PK__KhachHan__88D2F0E5D75789BC");

            entity.ToTable("KhachHang");

            entity.HasIndex(e => e.MaTaiKhoan, "UQ__KhachHan__AD7C65286EF8AC19").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaLoaiGiaoHang).HasName("PK__LoaiGiao__3A2972087543B1A4");
        ...
        {
            entity.HasKey(e => e.MaLoai).HasName("PK__LoaiSanP__730A57595EEC8294");
        ...
        {
            entity.HasKey(e => e.MaNhanVien).HasName("PK__NhanVien__77B2CA47C52EA084");

            entity.ToTable("NhanVien");

            entity.HasIndex(e => e.MaTaiKhoan, "UQ__NhanVien__AD7C652875DA2F04").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaSanPham).HasName("PK__SanPham__FAC7442D60EC8381");
            ...
            entity.HasIndex(e => e.MaSoSanPham, "UQ__SanPham__F2321537030486BC").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaTaiKhoan).HasName("PK__TaiKhoan__AD7C6529D05FADD0");
            ...
            entity.HasIndex(e => e.TaiKhoan, "UQ__TaiKhoan__D5B8C7F09A264B17").IsUnique();
        ...
        {
            entity.HasKey(e => e.MaThanhToan).HasName("PK__ThanhToa__D4B25844C38B75B3");
